                                            ...
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="sub-menu sub-menu-w1">
                                                    <div class="row row-cols-1 row-cols-lg-4 ">
                                                        <div class="col py-1">
                                                            <a href="../equity-stock-trading.html"
                                                                class="m-0 p-0 text-b">
                                                                <li class="d-flex gap-2 hover-effect mb-3 ">
                                                                    <div class="m-y">
                                                                        <img loading="lazy"
                                                                            src="../assets/img/equity-icon.png"
                                                        ...
                                                        <div class="col py-1">
                                                            <a href="../online-commodity-trading.html"
                                                                class="m-0 p-0 text-b">
                                                                <li class="d-flex gap-2 hover-effect mb-3 ">
                                                                    <div class="m-y">
                                                                        <img loading="lazy"
                                                                    ...
                                                                    <div class="my-auto">
                                                                        <p class="m-0 fs--14 fw-bold p-0">Commodity
                                                                        </p>
                                                                    </div>
                                                                    <div class="ani"></div>
                                                                </li>
                                                        ...
                                                        <div class="col py-1">
                                                            <a href="../open-demat-trading-account.html"
                                                                ...
                                                                <li class="d-flex gap-2 hover-effect mb-3">
                                                                    <div class="m-y">
                                                                        <img loading="lazy"
                                                                            src="../assets/img/demao-icon.png"
                                                                            alt="Demat Account" title="Demat Account">

                                                                    </div>
                                                                    <div class="my-auto">
                                                                        <p class="m-0 fs--14 fw-bold p-0">Demat
                                                                            Account
                                                                        </p>
                                                                    </div>
                                                                    <div class="ani"></div>
                                                        ...
                                                        <div class="col py-1">
                                                            <a href="../health-life-insurance-providers.html"
                                                                ...
                                                                <li class="d-flex gap-2 hover-effect mb-3">
                                                                    ...
                                                                    <div class="my-auto">
                                                                        <p class="m-0 fs--14 fw-bold p-0">Life &
                                                                            Health
                                                                            Insurance</p>
                                                                    </div>
                                                                    <div class="ani"></div>
                                                        ...
                                                        <div class="col py-1">
                                                            <a href="../nps-national-pension-system.html"
                                                                ...
                                                                <li class="d-flex gap-2 hover-effect mb-3">
                                                                    <div class="m-y">
                                                                        <img loading="lazy"
                                                                            src="../assets/img/nps-icon.png" alt="NPS"
                                                                            title="NPS">
                                                                    </div>
                                                                    <div class="my-auto">
                                                        ...
                                                        <div class="col py-1">
                                                            <a href="../pan-card-tan-tds-services.html"
                                                                class="m-0 p-0 text-b">
                                                        ...
                                                        <div class="col py-1">
                                                            <a href="../secretarial-services.html"
                                                                class="m-0 p-0 text-b">
                                                        ...
                                                        <div class="col py-1">
                                                            <a href="../invest-in-gold-etf.html" class="m-0 p-0 text-b">
                                                                ...
                                                                <li class="d-flex gap-2 hover-effect mb-3">
                                                                    <div class="m-y">
                                                                        <img loading="lazy"
                                                                            src="../assets/img/gold-icon.png" alt="Gold"
                                                                            title="Gold">
                                                        ...
                                                        <div class="col py-1">
                                                            <a href="../calculators.html"
                                                                ...
                                                                <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                                    ...
                                                                    <div class="my-auto">
                                                                        <p class=" m-0 fs--14 p-0 fw-bold">Calculators
                                                                        </p>
                                                                    </div>
                                                                    <div class="ani"></div>
                                                                </li>
                                                        ...
                                                        <div class="col py-1">
                                                            <a href="../faqs-frequently-asked-questions.html"
                                                                ...
                                                                <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                                    <div class="m-y">
                                                                        <img loading="lazy"
                                                                            src="../assets/img/faqs-icon.png" alt="FAQs"
                                                                            title="FAQs">
                                                                    </div>
                                                                    <div class="my-auto">
                                    ...
                                    <img loading="lazy" src="../assets/img/switzerland.png" alt="Switzerland" title="Switzerland">
                                                ...
                                                <div class="col py-1">
                                                    <a href="../gallery_7.html" class="p-0 m-0 text-b">
                                                        <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                            <div class="m-y">
                                                                <img loading="lazy" src="../assets/img/san-antonio.svg" alt="San Antonio"
                                                                    title="San Antonio">
                                                            </div>
                                                            <div class="my-auto">
                                                ...
                                                <div class="col py-1">
                                                    <a href="../gallery_6.html" class="p-0 m-0 text-b">
                                                        <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                            <div class="m-y">
                                                                <img loading="lazy" src="../assets/img/dubai.svg" alt="Dubai"
                                                                    title="Dubai">
                                                            </div>
                                                            <div class="my-auto">
                                                ...
                                                <div class="col py-1">
                                                    <a href="../gallery.html" class="p-0 m-0 text-b">
                                                        <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                            <div class="m-y">
                                                                <img loading="lazy" src="../assets/img/texas.svg" alt="Austin, texas"
                                                                    title="Austin, texas">
                                                            </div>
                                                            <div class="my-auto">
                                                ...
                                                <div class="col py-1">
                                                    <a href="../gallery_1.html" class="p-0 m-0 text-b">
                                                        <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                            <div class="m-y">
                                                                <img loading="lazy" src="../assets/img/san-fransisco.svg" alt="San Francisco"
                                                                    title="San Francisco">
                                                            </div>
                                                            <div class="my-auto">
                                                ...
                                                <div class="col py-1">
                                                    <a href="../gallery_2.html" class="p-0 m-0 text-b">
                                                        <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                            <div class="m-y">
                                                                <img loading="lazy" src="../assets/img/cleveland.svg" alt="Cleveland"
                                                                    title="Cleveland">
                                                            </div>
                                                            <div class="my-auto">
                                                ...
                                                <div class="col py-1">
                                                    <a href="../gallery_3.html" class="p-0 m-0 text-b">
                                                        <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                            <div class="m-y">
                                                                <img loading="lazy" src="../assets/img/dallas.svg" alt="Dallas"
                                                                    title="Dallas">
                                                            </div>
                                                            <div class="my-auto">
                                                ...
                                                <div class="col py-1">
                                                    <a href="../gallery_4.html" class="p-0 m-0 text-b">
                                                        <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                            <div class="m-y">
                                                                <img loading="lazy" src="../assets/img/raleigh.svg" alt="Raleigh"
                                                                    title="Raleigh">
                                                            </div>
                                                            <div class="my-auto">
                                                ...
                                                <div class="col py-1">
                                                    <a href="../gallery_5.html" class="p-0 m-0 text-b">
                                                        <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                            <div class="m-y">
                                                                <img loading="lazy" src="../assets/img/new-jersey.svg" alt="New Jersey"
                                                                    title="New Jersey">
                                                            </div>
                                                            <div class="my-auto">
                                            ...
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="sub-menu sub-menu-w2">
                                                    <div class="row row-cols-1 ">
                                                        ...
                                                        <div class="col py-1">
                                                            <a href="../initial-public-offering.html"
                                                                class="m-0 p-0 text-b">

                                                                <li class="d-flex gap-2 hover-effect mb-3">
                                                                    <div class="m-y">
                                                                        <img loading="lazy"
                                                                            src="../assets/img/ipo-icon.png" alt="IPO"
                                                                            title="IPO">
                                                                    </div>
                                                                    <div class="my-auto">
												...
												<div class="row row-cols-1 ">
													<div class="col">
														<a href="../gift-city-ifsc.html" class="p-0 m-0 text-b">
															<li class="d-flex gap-2 hover-effect mb-3 hover-effect">
																<div class="m-y">
																	<img loading="lazy" src="../assets/img/gift-city/about_us.png" alt="About Us"
																		title="About Us">
																</div>
													...
													<div class="col">
														<a href="../indiainxga.html" class="p-0 m-0 text-b">
															<li class="d-flex gap-2 hover-effect mb-3 hover-effect">
																<div class="m-y">
																	<img loading="lazy" src="../assets/img/gift-city/products.png" alt="Products"
																		title="Products">
																</div>
																<div class="lh-1 my-auto">
													...
													<div class="col">
														<a href="../policies-procedures.html" class="p-0 m-0 text-b">
															<li class="d-flex gap-2 hover-effect mb-3 hover-effect">
																<div class="m-y">
																	<img loading="lazy" src="../assets/img/gift-city/policies_procedures.png" alt="Policies & Procedures"
                                                        ...
                                                        <div class="col">
                                                            <a href="../event.html" class="p-0 m-0 text-b">
                                                                <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                                    <div class="m-y">
                                                                        <img loading="lazy"
                                                                            src="../assets/img/stri_event.png"
                                                                            alt="STRI Event" title="STRI Event">
                                                                    </div>
                                                                    <div class="lh-1 my-auto">
                                                                        <p class="lh-1 m-0 fs--14 p-0 fw-bold">STRI
                                                                            Event</p>
                                                                    </div>
                                                                    <div class="ani"></div>
                                                                </li>
                                                        ...
                                                        <div class="col">
                                                            <a href="../nps-login.html" class="p-0 m-0 text-b">
                                                                <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                                    <div class="m-y">
                                                                        <img loading="lazy"
                                                                            src="../assets/img/nps-login.png" alt="NPS"
                                                                            title="NPS">
                                                                    </div>
                                                                    <div class="lh-1 my-auto">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <a href="https://www.integratedindia.in/sp/businesspartner/FRLogin/login.aspx"
                                                                ...
                                                                <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                                    <div class="m-y">
                                                                        <img loading="lazy"
                                                                            src="../assets/img/franchisee.png"
                                                                            alt="Franchisee" title="Franchisee">
                                                                    </div>
                                                                    <div class="lh-1 my-auto">
                                                                        <p class="lh-1 m-0 fs--14 p-0 fw-bold">
                                                                            Franchisee
                                                                        </p>
                                            ...
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="sub-menu sub-menu-w2">
                                                    <div class="row row-cols-1 ">
                                                        ...
                                                        <div class="col">
                                                            <a href="../open-minor-demat-account.html"
                                                                class="p-0 m-0 text-b">
                                                                <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                                    <div class="m-y">
                                                                        <img loading="lazy"
                                                                    ...
                                                                    <div class="lh-1 my-auto">
                                                                        <p class="lh-1 m-0 fs--14 p-0 fw-bold">Minor
                                                                            Account</p>
                                                                    </div>
                                                                    <div class="ani"></div>
                                                                </li>
                                                        ...
                                                        <div class="col">
                                                            <a href="https://www.integratedindia.in/sp/NRIOnboarding_V2/NRIAccountOpenHome.aspx"
                                                                ...
                                                                <li class="d-flex gap-2 hover-effect mb-3 hover-effect">
                                                                    <div class="m-y">
                                                                        <img loading="lazy"
                                                                            src="../assets/img/nri-ac.png" alt="NRI"
                                                                            title="NRI">
                                                                    </div>
                                                                    <div class="lh-1 my-auto">
            ...
            <div class="chatbot hidden">
                ...
                <ul class="chatbox">
                    <li class="chat incoming">
                        <p>Myself Chanakya, I am here to assist you today I can help you with the queries
                            relating to the
